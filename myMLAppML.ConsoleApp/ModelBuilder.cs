...
namespace MyMLAppML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\daraks\source\repos\myMLApp\wikipedia-detox-250-line-data.tsv.txt";
        private static string MODEL_FILEPATH = @"C:\Users\daraks\AppData\Local\Temp\MLVSTools\myMLAppML\myMLAppML.Model\MLModel.zip";
